pipeline {
    ...
    environment {
        ...
        GIT_CREDENTIALS ='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'  // Référence au token GitHub stocké dans Jenkins
    }
    stages {
